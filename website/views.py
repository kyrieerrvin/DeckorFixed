...
def contact(request):
	if request.method == "POST":
		...
		send_mail(
			...
			[message_email, ], # PUT ADMIN EMAIL BESIDE COMMA OF message_email WITH ' ' like 'admin@gmail.com'
...
def appointment(request):
	if request.method == "POST":
		...
		send_mail(
			...
			[your_email, ], # To Email:    PUT ADMIN EMAIL BESIDE COMMA OF your_email WITH ' ' like 'admin@gmail.com'
			)
